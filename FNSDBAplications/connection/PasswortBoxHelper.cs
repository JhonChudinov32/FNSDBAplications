...
namespace  FNSDBAplications.connection
{
    ...
    {
        // Вызываем свойство PasswordHelper.Attach. Дополнительное свойство PasswordHelper.Password предоставляет привязываемую копию исходного свойства пароля элемента управления PasswordBox.
